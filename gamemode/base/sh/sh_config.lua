...
hook.Add('Initialize', 'DefaultSounds', function()
    ...
    GAMEMODE:RegisterTauntPack('default', {
        hunter = {
            ...
            {name = 't_checked', label = 'Vader, Check the shipt', file = 'lps/taunts/hunter/t_checked.mp3', length = 3.84},
        ...
        prop = {
            ...
            {name = 't_acdc', label = 'DC Back in black', file = 'lps/taunts/prop/t_acdc.mp3', length = 6.1387755102040815},
            ...
            {name = 't_intermission', label = 'Intermission theme', file = 'lps/taunts/prop/t_intermission.mp3', length = 8.202448979591837},
            ...
            {name = 't_turret_anyone_there', label = 'Turret, Is anyone there?', file = 'lps/taunts/prop/t_turret_anyone_there.mp3', length = 1.4628571428571429},
            ...
            {name = 't_scream', label = 'Manly Scream', file = 'lps/taunts/prop/t_scream.mp3', length = 2.4293877551020406},
            ...
            {name = 't_rainin_tacos', label = 'It\'s raining tacos!', file = 'lps/taunts/prop/t_rainin_tacos.mp3', length = 17.6065306122449},
            ...
            {name = 't_eagleblimp', label = 'GLaDOS, Eagle blimp', file = 'lps/taunts/prop/t_eagleblimp.mp3', length = 6.164897959183674},
            {name = 't_sofat', label = 'GLaDOS, So fat', file = 'lps/taunts/prop/t_sofat.mp3', length = 8.986122448979591},
        },
        lastman = {
            {name = 't_annihilate', label = 'Annihilate', file = 'lps/taunts/lastman/t_annihilate.mp3', length = 70.84408163265306},{name = 't_birthdaycake', label = 'Birthday cake', file = 'lps/taunts/lastman/t_birthdaycake.mp3', length = 70.37387755102041},
            ...
            {name = 't_outoftime2', label = 'Times up 1', file = 'lps/taunts/lastman/t_outoftime2.mp3', length = 72.69877551020409},{name = 't_rise2', label = 'Rise 2', file = 'lps/taunts/lastman/t_rise2.mp3', length = 73.19510204081632},
            ...
            {name = 't_outoftime1', label = 'Times up 2', file = 'lps/taunts/lastman/t_outoftime1.mp3', length = 70.60897959183673},{name = 't_turndown', label = 'Turn down for what', file = 'lps/taunts/lastman/t_turndown.mp3', length = 70.6873469387755},
