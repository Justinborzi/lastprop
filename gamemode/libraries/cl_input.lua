...
lps.input = lps.input or {
    keys = {
        {KEY_BACKSPACE,     8,   false, 'BACK SPACE'},
        {KEY_TAB,           9,   false, 'TAB'},
        {KEY_ENTER,         13,  false, 'ENTER'},
        {KEY_PAD_ENTER,     13,  false, 'NUMPAD ENTER'},
        {KEY_LSHIFT,        13,  false, 'L SHIFT'},
        {KEY_RSHIFT,        13,  false, 'R SHIFT'},
        {KEY_LCONTROL,      17,  false, 'L CONTROL'},
        {KEY_RCONTROL,      17,  false, 'R CONTROL'},
        {KEY_LALT,          18,  false, 'L ALT'},
        {KEY_RALT,          18,  false, 'R ALT'},
        -- Pause/Break, 19
        {KEY_CAPSLOCK,      20,  false, 'CAPS LOCK'},
        {KEY_ESCAPE,        27,  false, 'ESCAPE'},
        {KEY_PAGEUP,        33,  false, 'PAGE UP'},
        {KEY_SPACE,         32,  false, 'SPACE'},
        {KEY_PAGEDOWN,      34,  false, 'PAGE DOWN'},
        ...
        {KEY_Z,             90,  false, 'Z'},
        -- Select, 93
        {KEY_PAD_0,         96,  false, 'P0'},
        {KEY_PAD_1,         97,  false, 'P1'},
        {KEY_PAD_2,         98,  false, 'P2'},
        {KEY_PAD_3,         99,  false, 'P3'},
        {KEY_PAD_4,         100, false, 'P4'},
        {KEY_PAD_5,         101, false, 'P5'},
        {KEY_PAD_6,         102, false, 'P6'},
        {KEY_PAD_7,         103, false, 'P7'},
        {KEY_PAD_8,         104, false, 'P8'},
        {KEY_PAD_9,         105, false, 'P9'},
        {KEY_PAD_MULTIPLY,  105, false, 'P*'},
        {KEY_PAD_PLUS,      107, false, 'P+'},
        {KEY_PAD_MINUS,     109, false, 'P-'},
        {KEY_PAD_DECIMAL,   110, false, 'P.'},
        {KEY_PAD_DIVIDE,    111, false, 'P/'},
        {KEY_F1,            112, false, 'F1'},
        {KEY_F2,            113, false, 'F2'},
        {KEY_F3,            114, false, 'F3'},
        {KEY_F4,            115, false, 'F4'},
        ...
        {KEY_NUMLOCK,       144, false, 'NUM LOCK'},
        {KEY_SCROLLLOCK,    145, false, 'SCROLL LOCK'},
