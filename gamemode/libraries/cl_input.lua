...
lps.input = lps.input or {
    keys = {
        {KEY_BACKSPACE,     8,   false, 'BCK'},
        {KEY_TAB,           9,   false, 'TAB'},
        {KEY_ENTER,         13,  false, 'ENT'},
        {KEY_PAD_ENTER,     13,  false, 'NUM ENT'},
        {KEY_LSHIFT,        13,  false, 'L SFT'},
        {KEY_RSHIFT,        13,  false, 'R SFT'},
        ...
        -- Home, 36
        {KEY_LEFT,          37,  false, 'LFT'},
        {KEY_UP,            38,  false, 'UP'},
        {KEY_RIGHT,         39,  false, 'RHT'},
        {KEY_DOWN,          40,  false, 'DWN'},
        {KEY_INSERT,        45,  false, 'INS'},
        ...
        {KEY_SCROLLLOCK,    145, false, 'SCR LK'},
